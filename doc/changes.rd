=begin
# $Id: changes.rd,v 1.2.2.2 2003/04/30 02:49:28 katsu Exp $
...
=== 0.2.2 - Feb 17, 2003
  ...
  * Fixed a fatal bug in scanner.rb.

  * XMLScan::HTMLScanner allows to include slashes('/') in an attribute value.
